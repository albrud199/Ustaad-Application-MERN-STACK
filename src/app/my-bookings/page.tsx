    ...
    <div className="min-h-screen flex flex-col bg-surface overflow-x-hidden">
      ...
      <main className="flex-1 pt-32 pb-24 px-6 md:px-12 max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="flex gap-4 mb-10 overflow-x-auto pb-2 no-scrollbar">
            <button className="px-8 py-3 rounded-xl bg-primary-fixed text-on-primary-fixed font-semibold transition-all shadow-[0_0_20px_rgba(163,166,255,0.3)] shrink-0">
                Active
            </button>
            <button className="px-8 py-3 rounded-xl glass-card text-on-surface hover:bg-surface-container-highest transition-all shrink-0">
                Upcoming
            </button>
            <button className="px-8 py-3 rounded-xl glass-card text-on-surface hover:bg-surface-container-highest transition-all shrink-0">
                Past
            ...
            <div className="lg:col-span-9 space-y-6">
                ...
                <div className="glass-card rounded-xl p-6 flex flex-col md:flex-row gap-6 relative group overflow-hidden border border-primary/30">
                    ...
                    <div className="w-full md:w-48 h-48 rounded-lg overflow-hidden flex-shrink-0 relative">
                        <Image src="https://lh3.googleusercontent.com/aida-public/AB6AXuCtNKLctsxMcamNRfBpNrhXWZUoNRKAGwRUzGIB5BfHw4mupF_FJCkbHLrK7VGTRmg2o_ByYr95kCdNLVWv-WiwNHLdKOcgn6OwFXK80GJf9b_P64ZHySrlzmSFpTasQfnNV_f5rCZJH5Q48J-8mjiyGawzMLULUpQ3j1NMUAYx9D8nC9_Z7jNGwSExKVAgqrUEM2B7E4sfLDWoeoBd24hD1naLcUwVfPZ1GSyy8IV-Knp4K-horTVl3wjPDyPDwSPVWv50o-iP58I" alt="Parking" fill className="object-cover group-hover:scale-105 transition-transform duration-700" />
                    </div>
